...
3, RagnellGoW’s spoken tutorial on the AQ IJ:
...
- ledges? Should test that out some time. §
...
contraption that leads to the Theseus fight. Once you’ve gained enough height,
use the Spear of Destiny’s Square combo to inch yourself slightly forward to
...
2, RagnellGoW’s vid of the second method:
...
stretch of the game. § (thanks to Ahmad Shah for reminding of this)
...
it unload, allowing infinite red orbs v3 glitch to happen. (c: GMG) §
...
something more to it. Remains a mystery for now. §
...
+ checkpoint (at the chasm leading to fight arena) §
